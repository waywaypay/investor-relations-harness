...
CSV = (
    ...
    "F_MRDN,MRDN,total_revenue,FY2026-Q1,1241.3,millions,1241300000,currency,-5,"
    "edgar_xbrl,acc#rev,10-Q p.4,2026-04-28,high\n"
    "F_MRDN,MRDN,q2_revenue_guidance,FY2026-Q2,1325.0,millions,1325000000,currency,,"
    "management_input,none,memo,2026-04-21,medium\n"
)


def test_facts_from_csv_parses_rows():
    facts = facts_from_csv(io.StringIO(CSV), tenant_id="meridian")
    assert len(facts) == 2
