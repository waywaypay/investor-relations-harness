...
(localStorage); the demo close pack is always re-seeded.
...
src/
  ...
  components/   TopBar, Sidebar, DocumentView, FigureModal, NarrativeModal,
                CommitmentModal, UploadModal, Popover, TrendChart, Consensus, Calendar
  lib/          verify (client-side echo of the tie-out logic), buildDoc
                (assemble an uploaded document into renderable blocks/figures), icons
